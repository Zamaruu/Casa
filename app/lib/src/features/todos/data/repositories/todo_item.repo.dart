...
class TodoItemRepoSource extends TypedRepoSource<ITodoItem, ITodoItemApi> {
...
abstract class TodoItemRepo extends TypedCacheRepo<ITodoItem, ITodoItemApi> {
  TodoItemRepo({required super.source});

  Future<IValueResponse<List<ITodoItem>>> findByListId(String listId) => source.api.findByListId(listId);
}
